...
public class ReservationPolicyStepTest extends IntegrationTest {
    ...
    class PastReservationPolicy {
        ...
        void 어제_날짜는_거부() {
            ReservationCreateCommand command = new ReservationCreateCommand(
                    memberId, TODAY.minusDays(1), timeId10, themeId
            );
        ...
        void 오늘이지만_이미_지난_시간은_거부() {
            ReservationCreateCommand command = new ReservationCreateCommand(
                    memberId, TODAY, timeId10, themeId
            );
        ...
        void 오늘이지만_미래_시간은_허용() {
            ...
            ReservationCreateCommand command = new ReservationCreateCommand(
                    memberId, TODAY, timeId15, themeId
            );
        ...
        void 내일_날짜는_허용() {
            ReservationCreateCommand command = new ReservationCreateCommand(
                    memberId, TODAY.plusDays(1), timeId10, themeId
            );
    ...
    class DuplicateReservationPolicy {
        ...
        void 같은_날짜_시간_테마_중복은_거부() {
            ...
            Long memberIdB = helper.insertMember("other@test.com", "pass", "다른사람");

            reservationService.create(new ReservationCreateCommand(memberId, futureDate, timeId10, themeId));

            assertThatThrownBy(() -> reservationService.create(
                    new ReservationCreateCommand(memberIdB, futureDate, timeId10, themeId)))
                    .isInstanceOf(BusinessRuleViolationException.class)
        ...
        void 같은_날짜_시간이지만_테마가_다르면_허용() {
            ...
            assertThatCode(() -> reservationService.create(
                    new ReservationCreateCommand(memberId, futureDate, timeId10, anotherThemeId)))
                    .doesNotThrowAnyException();
        }
    }
    ...
    class InputValidationPolicy {
        ...
        void 날짜_null_거부() {
            assertThatThrownBy(() -> reservationService.create(new ReservationCreateCommand(
                    memberId, null, timeId10, themeId
            )))
                    .isInstanceOf(InvalidCommandException.class)
